...
<form:form method="post" enctype="multipart/form-data"
	action="staffs/add.htm" modelAttribute="StaffEntity">
			...
			<div class="col-lg-6 col-ml-12">
				<div class="row">
					...
					<div class="col-12 mt-5">
						<div class="card">
							<div class="card-body">
								<h4 class="header-title"><s:message code="global.menu.staff" /></h4>
								<p class="text-muted font-14 mb-4"><s:message code="staff.title" /></p>
								<div class="form-group">
									<label for="example-text-input" class="col-form-label"><s:message code="staff.id" /></label>
									<form:input class="form-control" type="text" name="Id"
										id="example-text-input" path="Id" required="required" />
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div>
										<input value="" type="file" name="Photo" id="file-2"
											class="inputfile inputfile-2" required="required" />
										<label for="file-2"><svg
