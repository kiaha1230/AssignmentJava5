...
<form:form method="post" enctype="multipart/form-data"
	action="record/edit.htm" modelAttribute="RecordEntity">
						...
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted font-14 mb-4">
									<s:message code="record.title.edit" />
								</p>

								<div class="form-group">
									<form:hidden path="Id" />
									<label for="example-email-input" class="col-form-label">Type</label>
									<div>
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<form:input path="Date" class="form-control" type="date"
												name="Birthday" id="example-date-input" />
										</div>
										<div class="form-group">
											<label for="example-text-input" class="col-form-label"><s:message
